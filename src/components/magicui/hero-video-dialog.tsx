...
export default function HeroVideoDialog({
  ...
  const thumbnail = thumbnailSrc || "/api/placeholder/400/320";
              ...
              <div className="relative isolate z-[1] size-full overflow-hidden rounded-2xl border-2 border-white">
                {isPlaying ? (
                  ...
                  <div className="relative size-full">
                    ...
                    >
                      <div className="flex size-28 items-center justify-center rounded-full bg-primary/10 backdrop-blur-md">
                        <div className="relative flex size-20 scale-100 items-center justify-center rounded-full bg-gradient-to-b from-primary/30 to-primary shadow-md transition-all duration-200 ease-out hover:scale-[1.2]">
                          <Play
                            className="size-8 scale-100 fill-white text-white transition-transform duration-200 ease-out hover:scale-105"
                            style={{
                              filter:
                                "drop-shadow(0 4px 3px rgb(0 0 0 / 0.07)) drop-shadow(0 2px 2px rgb(0 0 0 / 0.06))",
                            }}
